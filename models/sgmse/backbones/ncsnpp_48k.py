...
class NCSNpp_48k(nn.Module):
    ...
    def add_argparse_args(parser):
        parser.add_argument("--ch-mult",type=int, nargs='+', default=[1,1,2,2,2,2,2])
        parser.add_argument("--num-res-blocks", type=int, default=2)
        parser.add_argument("--attn-resolutions", type=int, nargs='+', default=[])
        ...
        parser.add_argument("--progressive-input", type=str, default='none', help="Progressive upsampling method")
